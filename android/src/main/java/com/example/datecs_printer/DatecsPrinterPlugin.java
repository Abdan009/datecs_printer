package com.example.datecs_printer;
...
public class DatecsPrinterPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    if (call.method.equals("getPlatformVersion")) {
    ...
    }else if(call.method.equals("getInformation")){
      try {
      ...
      try {
        ...
        mPrinter.printQRCode(14, 4, "QR TEST YAP TEST TEST LAGI");
        mPrinter.flush();
        result.success(true);
      } catch (Exception e) {
        result.success(false);
        ...
        for(int i = 0; i < args.size(); i++){
          if(args.get(i).contains("feed%20")){
            ...
            if(android.os.Build.VERSION.SDK_INT >= 26){
              ...
              resized.recycle();
              mPrinter.printImage(argb, 300, 300, Printer.ALIGN_CENTER, false);
            }else{
